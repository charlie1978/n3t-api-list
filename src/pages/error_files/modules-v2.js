...
`},6964:function(e,t,n){"use strict";var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.CTAButton=t.UICTAButton=void 0;const r=n(1032),o=n(8661),s=n(3764),a=i(n(7337)),l=n(6058),u=n(2282);t.UICTAButton=(0,a.default)((({popup:e,onClick:t,getter:n,noInterpolation:i,className:o})=>{const s=window.hellobar.previewMode?"editable":"";return(0,r.jsx)("div",{className:`hb-cta ${o}`,onClick:t,children:(0,r.jsx)(u.DynamicContent,{className:s,id:"link_text",noInterpolation:i,getter:n})})}))`
  &.hb-cta {
...
`},2282:(e,t,n)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.DynamicContent=void 0;const i=n(1032),r=n(396);t.DynamicContent=({getter:e,className:t,onClick:n,id:o})=>{const[s,a]=(0,r.useState)(e());return(0,r.useEffect)((()=>{if(window.hellobar.previewMode){const e=new Event("editable.mounted");e.data={id:o},o&&window.hellobar.dispatchEvent(e)}return()=>{if(window.hellobar.previewMode){const e=new Event("editable.unmount");e.data={id:o},o&&window.hellobar.dispatchEvent(e)}}}),[]),(0,r.useEffect)((()=>{a(e())}),[e()]),(0,r.useEffect)((()=>{window.hellobar.onUpdate((()=>{a(e())}))}),[]),(0,i.jsx)("div",{onClick:n,id:o,className:t,dangerouslySetInnerHTML:{__html:s}})}},6862:function(e,t,n){"use strict";var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Form=t.ValidationError=void 0;const r=n(1032),o=n(6964),s=i(n(7337)),a=n(8661),l=n(396),u=n(3764),c=n(6058),d=i(n(6753));class p extends Error{constructor(e){super(),this.message="Validation error",this.name="ValidationError",this.inputs=e}}t.ValidationError=p;const h=(0,s.default)((({input:e,className:t,value:n,onChange:i,...o})=>{var s;return(0,r.jsxs)("label",{className:t,children:["select"!==e.type&&(0,r.jsx)("input",{type:e.inputType,name:e.name,placeholder:e.placeholder,required:e.required,onChange:i,value:n,...o}),"select"===e.type&&(0,r.jsxs)("select",{name:e.name,id:e.name,required:e.required,onChange:i,...o,children:[(0,r.jsx)("option",{value:"",children:e.label}),null===(s=e.options)||void 0===s?void 0:s.split(",").map((e=>(0,r.jsx)("option",{value:e.trim(),children:e.trim()})))]})]})}))`
  span {
    display: none;
  }
...
`;t.Form=function({popup:e,className:t,children:n}){const i=(0,a.useContext)(u.StateContext),s=(0,l.useRef)(null),c=e=>{var t;const n=null===(t=e.target)||void 0===t?void 0:t.name;i.updateValues({[n]:e.target.value})},f=()=>{s.current.classList.remove("submitted")};return(0,l.useEffect)((()=>{e.form.enabledInputs.forEach((e=>{i.updateValues({[e.name]:e.value})}))}),[]),"social"===e.subtype?(0,r.jsx)(d.default,{popup:e}):e.form.enabled?(0,r.jsxs)("div",{className:["hb-form",t].join(" "),ref:s,children:[e.form.enabledInputs.map((e=>(0,r.jsx)(h,{onChange:c,value:i.inputValues[e.name],input:e,onFocus:f}))),e.cta?(0,r.jsx)(o.CTAButton,{popup:e,onSubmit:()=>{if(window.hellobar.previewMode)return;const e=s.current,t=e.querySelectorAll("input:invalid, select:invalid");if(e.classList.remove("submitted"),t.forEach((e=>{setTimeout((()=>{e.checkValidity()}),500)})),t.length>0)throw e.classList.add("submitted"),new p(t)}}):null,n]}):null}},9701:function(e,t,n){"use strict";var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.GdprForm=void 0;const r=n(1032),o=i(n(7337)),s=n(6964),a=n(8661),l=n(3764),u=n(396),c=n(6862),d=n(6058);t.GdprForm=(0,o.default)((({className:e,popup:t})=>{const n=(0,a.useContext)(l.StateContext),{action:i,consent:o,agreement:d}=window.hellobar.gdpr,p=(0,u.useRef)(null),h=()=>{if(!p.current)throw new c.ValidationError([]);const e=p.current,t=e.querySelectorAll("input:invalid");if(t.length>0)throw e.classList.add("animated"),e.addEventListener("animationend",(()=>{e.classList.remove("animated")})),new c.ValidationError(t)};return(0,r.jsxs)("div",{className:e,ref:p,children:[(0,r.jsxs)("label",{children:[(0,r.jsx)("input",{required:!0,type:"checkbox"}),(0,r.jsx)("p",{children:o})]}),(0,r.jsxs)("label",{children:[(0,r.jsx)("input",{required:!0,type:"checkbox"}),(0,r.jsx)("p",{dangerouslySetInnerHTML:{__html:d}})]}),(0,r.jsx)(s.UICTAButton,{getter:()=>i,popup:t,noInterpolation:!0,className:e,onClick:()=>{if(!t.cta)return;const e=t.cta.action({afterGdprSubmit:!0});e.input(n.inputValues),e.validate(h),e.run().catch((e=>"ValidationError"!==e.name&&console.error(e)))}})]})}))`
  --input-min-width: 100%;
  --input-width: 100%;
  --headline-link-text-decoration: underline !important;
  display: flex;
...
`},4491:(e,t,n)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.DefaultPageSwitch=t.Default=t.Page=t.PageSwitch=void 0;const i=n(1032),r=n(6400),o=n(396),s=n(8661),a=n(9566),l=n(9701),u=(0,r.createContext)({page:"default",popup:null,rendered:!1});t.PageSwitch=({popup:e,children:t})=>{const[n,r]=(0,o.useState)("default");return(0,o.useEffect)((()=>{window.hellobar.onUpdate((()=>{r(e.getValue("page"))}))}),[]),(0,i.jsx)(u.Provider,{value:{page:n,popup:e,rendered:!1},children:t})},t.Page=({component:e,name:t})=>{const n=(0,s.useContext)(u);return n.rendered=n.rendered||n.page===t,n.page===t?(0,r.createElement)(e,{popup:n.popup}):null},t.Default=({children:e})=>(0,s.useContext)(u).rendered?null:(0,i.jsx)(r.Fragment,{children:e}),t.DefaultPageSwitch=({popup:e,children:n})=>(0,i.jsxs)(t.PageSwitch,{popup:e,children:[(0,i.jsx)(t.Page,{name:"gdpr",component:l.GdprForm}),(0,i.jsx)(t.Page,{name:"thank-you",component:a.ThankYouContent}),(0,i.jsx)(t.Default,{children:n})]})},9566:function(e,t,n){"use strict";var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.ThankYouContent=t.CloseButton=void 0;const r=n(1032),o=n(4947),s=i(n(7337)),a=n(2282);t.CloseButton=(0,s.default)((({className:e,popup:t})=>{const n=window.hellobar.previewMode?"editable":"";return(0,r.jsx)("div",{className:`hb-cta ${e}`,onClick:()=>{window.hellobar.previewMode||t.remove()},children:(0,r.jsx)(a.DynamicContent,{className:n,id:"conversion_cta_text",getter:()=>t.content.closeButtonText})})}))`
  &.hb-cta {
    min-height: var(--btn-min-height);
    display: flex;
    align-items: center;
...
`:"";t.Berlin={...s.NullTheme,$id:"azuki",Layout:({popup:e})=>(0,a.default)(e,"position-top"),Base:()=>r.css`
  ...
  `,Takeover:()=>i.css`
    ...
    --btn-min-height: 70px;
    --gap: 2em;
  `}},3893:(e,t,n)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.Cologne=void 0;const i=n(917),r=n(1641);t.Cologne={...r.NullTheme,$id:"pulse",Base:()=>i.css`
    --text-align: center;
...
`},4300:(e,t,n)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.HongKong=void 0;const i=n(1641);t.HongKong={...i.NullTheme,$id:"hong-kong"}},5349:(e,t,n)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.Houston=void 0;const i=n(1641);t.Houston={...i.NullTheme,$id:"classic"}},5323:function(e,t,n){"use strict";var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.getOverrides=t.getTheme=void 0;const r=n(917),o=i(n(1114)),s=i(n(1544)),a=n(1641),l=n(2186),u=n(5828),c=n(8965),d=n(2456),p=n(2050),h=n(5789),f=n(3825),m=n(7206),g=n(2706),v=n(6392),_=n(3377),b=n(9363),w=n(6122),y=n(3893),x=n(4862),S=n(5702),E=n(9165),C=n(8820),M=n(1426),T=n(5644),k=n(4300),P=n(5349),O=n(6615),j=n(8409),N=n(6501),A=n(7007),V=n(2858),I=n(4622),$=n(4725),D=n(3272),R=n(1727),B=n(4676),z=n(8278),L=n(5391),F=n(7641),G=n(755),H=n(1116),W=n(6212),U=n(1900),K=n(1947),Y=n(8882),q=n(1542),Z=n(5135),X=n(6179),J=n(5604),Q=n(4746),ee=n(496),te=n(2560),ne={none:a.NullTheme,[Z.Amsterdam.$id]:Z.Amsterdam,[f.Austin.$id]:f.Austin,[u.Berlin.$id]:u.Berlin,[l.Atlanta.$id]:l.Atlanta,[c.Bogota.$id]:c.Bogota,[d.Brooklyn.$id]:d.Brooklyn,[p.Seattle.$id]:p.Seattle,[h.PortElizabet.$id]:h.PortElizabet,[m.Denpasar.$id]:m.Denpasar,[g.Rosarito.$id]:g.Rosarito,[v.Sydney.$id]:v.Sydney,[_.LosAngeles.$id]:_.LosAngeles,[b.Belgrade.$id]:b.Belgrade,[w.Bradford.$id]:w.Bradford,[y.Cologne.$id]:y.Cologne,[x.Corleone.$id]:x.Corleone,[S.Dallas.$id]:S.Dallas,[E.Dublin.$id]:E.Dublin,[C.Edmonton.$id]:C.Edmonton,[M.GoldCoast.$id]:M.GoldCoast,[T.Guadalajara.$id]:T.Guadalajara,[k.HongKong.$id]:k.HongKong,[P.Houston.$id]:P.Houston,[O.Istanbul.$id]:O.Istanbul,[j.Kawasaki.$id]:j.Kawasaki,[N.Kyoto.$id]:N.Kyoto,[A.Lahore.$id]:A.Lahore,[V.Lyon.$id]:V.Lyon,[I.Manila.$id]:I.Manila,[$.Minsk.$id]:$.Minsk,[D.Moscow.$id]:D.Moscow,[R.Nashville.$id]:R.Nashville,[B.NewOrleans.$id]:B.NewOrleans,[z.Philadelphia.$id]:z.Philadelphia,[L.Portland.$id]:L.Portland,[J.Paris.$id]:J.Paris,[F.Salta.$id]:F.Salta,[G.SantaFe.$id]:G.SantaFe,[H.SaoPaulo.$id]:H.SaoPaulo,[W.Singapore.$id]:W.Singapore,[U.Tokyo.$id]:U.Tokyo,[K.Valencia.$id]:K.Valencia,[Y.Winnipeg.$id]:Y.Winnipeg,[q.Bucharest.$id]:q.Bucharest,[X.SanDiego.$id]:X.SanDiego,[Q.MexicoCity.$id]:Q.MexicoCity,[ee.Mumbai.$id]:ee.Mumbai,[te.Oaxaca.$id]:te.Oaxaca};t.getTheme=function(e){return ne[e.themeId]||console.info("Use simple theme for the Bar type instead of:",e.themeId),t=ne[e.themeId]||ne.none,e=>r.css`
      ${(0,s.default)(e)}
      & {
        ${t.Layout(e)};
        ${t.Base(e)};
