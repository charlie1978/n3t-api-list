...
import DogBreedDetails from './pages/DogBreedDetails';
...
import SongDetails from './pages/SongDetails'; // Importar el nuevo componente
    ...
    <Router>
      <div>
        ...
        <main>
          ...
          <Route path="/breeds/:name" component={DogBreedDetails} />
          <Route path="/BreedDetails/:name" component={BreedDetails} />
          ...
          <Route path="/artist/:artistId/songs" component={ArtistSongs} /> {/* Ruta para canciones del artista */}
          <Route path="/song/:artistId/:songId" component={SongDetails} /> {/* Nueva ruta para detalles de la canción */}
          <Route exact path="/Artist" component={ArtistList} /> {/* Lista de artistas */}
          <Route path="/artist/:artistId" component={ArtistDetails} /> {/* Detalles del artista */}
        </main>
      </div>
